...
*/
  ...
  String getGrib2Filename (int k, int l, int h) {
    ...
    if (DATA_allDomains[Current_domainID][DOMAIN_PROPERTY02].equals("CMC")) {
      ...
      if (l == LAYER_precipitation) {
        if (DATA_allDomains[Current_domainID][DOMAIN_PROPERTY01].equals("REPS")) {
          F_L = "APCP_SFC";
          DATA_ParameterLevel[l][h] = F_L;
        }
      }
...
switch (this.IdentificationOfCentre) {
            case 0: dataCentre = "WMO Secretariat"; break;
            case 1: dataCentre = "Melbourne"; break;
            case 2: dataCentre = "Melbourne"; break;
            case 3: dataCentre = "Melbourne"; break;
            case 4: dataCentre = "Moscow"; break;
            case 5: dataCentre = "Moscow"; break;
            case 6: dataCentre = "Moscow"; break;
            case 7: dataCentre = "US National Weather Service - National Centres for Environmental Prediction (NCEP)"; break;
            case 8: dataCentre = "US National Weather Service Telecommunications Gateway (NWSTG)"; break;
            case 9: dataCentre = "US National Weather Service - Other"; break;
            case 10: dataCentre = "Cairo (RSMC)"; break;
            case 11: dataCentre = "Cairo (RSMC)"; break;
            case 12: dataCentre = "Dakar (RSMC)"; break;
            case 13: dataCentre = "Dakar (RSMC)"; break;
            case 14: dataCentre = "Nairobi (RSMC)"; break;
            case 15: dataCentre = "Nairobi (RSMC)"; break;
            case 16: dataCentre = "Casablanca (RSMC)"; break;
            case 17: dataCentre = "Tunis (RSMC)"; break;
            case 18: dataCentre = "Tunis-Casablanca (RSMC)"; break;
            case 19: dataCentre = "Tunis-Casablanca (RSMC)"; break;
            case 20: dataCentre = "Las Palmas"; break;
            case 21: dataCentre = "Algiers (RSMC)"; break;
            case 22: dataCentre = "ACMAD"; break;
            case 23: dataCentre = "Mozambique (NMC)"; break;
            case 24: dataCentre = "Pretoria (RSMC)"; break;
            case 25: dataCentre = "La Réunion (RSMC)"; break;
            case 26: dataCentre = "Khabarovsk (RSMC)"; break;
            case 27: dataCentre = "Khabarovsk (RSMC)"; break;
            case 28: dataCentre = "New Delhi (RSMC)"; break;
            case 29: dataCentre = "New Delhi (RSMC)"; break;
            case 30: dataCentre = "Novosibirsk (RSMC)"; break;
            case 31: dataCentre = "Novosibirsk (RSMC)"; break;
            case 32: dataCentre = "Tashkent (RSMC)"; break;
            case 33: dataCentre = "Jeddah (RSMC)"; break;
            case 34: dataCentre = "Tokyo (RSMC), Japan Meteorological Agency"; break;
            case 35: dataCentre = "Tokyo (RSMC), Japan Meteorological Agency"; break;
            case 36: dataCentre = "Bangkok"; break;
            case 37: dataCentre = "Ulaanbaatar"; break;
            case 38: dataCentre = "Beijing (RSMC)"; break;
            case 39: dataCentre = "Beijing (RSMC)"; break;
            case 40: dataCentre = "Seoul"; break;
            case 41: dataCentre = "Buenos Aires (RSMC)"; break;
            case 42: dataCentre = "Buenos Aires (RSMC)"; break;
            case 43: dataCentre = "Brasilia (RSMC)"; break;
            case 44: dataCentre = "Brasilia (RSMC)"; break;
            case 45: dataCentre = "Santiago"; break;
            case 46: dataCentre = "Brazilian Space Agency - INPE"; break;
            case 47: dataCentre = "Colombia (NMC)"; break;
            case 48: dataCentre = "Ecuador (NMC)"; break;
            case 49: dataCentre = "Peru (NMC)"; break;
            case 50: dataCentre = "Venezuela (Bolivarian Republic of) (NMC)"; break;
            case 51: dataCentre = "Miami (RSMC)"; break;
            case 52: dataCentre = "Miami (RSMC), National Hurricane Center"; break;
            case 53: dataCentre = "MSC Monitoring"; break;
            case 54: dataCentre = "Montreal (RSMC)"; break;
            case 55: dataCentre = "San Francisco"; break;
            case 56: dataCentre = "ARINC Center"; break;
            case 57: dataCentre = "US Air Force - Air Force Global Weather Center"; break;
            case 58: dataCentre = "Fleet Numerical Meteorology and Oceanography Center, Monterey, CA, United States"; break;
            case 59: dataCentre = "The NOAA Forecast Systems Laboratory, Boulder, CO, United States"; break;
            case 60: dataCentre = "United States National Center for Atmospheric Research (NCAR)"; break;
            case 61: dataCentre = "Service ARGOS - Landover"; break;
            case 62: dataCentre = "US Naval Oceanographic Office"; break;
            case 63: dataCentre = "International Research Institute for Climate and Society (IRI)"; break;
            case 64: dataCentre = "Honolulu (RSMC)"; break;
            case 65: dataCentre = "Darwin (RSMC)"; break;
            case 66: dataCentre = "Darwin (RSMC)"; break;
            case 67: dataCentre = "Melbourne (RSMC)"; break;
            case 69: dataCentre = "Wellington (RSMC)"; break;
            case 70: dataCentre = "Wellington (RSMC)"; break;
            case 71: dataCentre = "Nadi (RSMC)"; break;
            case 72: dataCentre = "Singapore"; break;
            case 73: dataCentre = "Malaysia (NMC)"; break;
            case 74: dataCentre = "UK Meteorological Office - Exeter (RSMC)"; break;
            case 75: dataCentre = "UK Meteorological Office - Exeter (RSMC)"; break;
            case 76: dataCentre = "Moscow (RSMC)"; break;
            case 78: dataCentre = "Offenbach (RSMC)"; break;
            case 79: dataCentre = "Offenbach (RSMC)"; break;
            case 80: dataCentre = "Rome (RSMC)"; break;
            case 81: dataCentre = "Rome (RSMC)"; break;
            case 82: dataCentre = "Norrköping"; break;
            case 83: dataCentre = "Norrköping"; break;
            case 84: dataCentre = "Toulouse (RSMC)"; break;
            case 85: dataCentre = "Toulouse (RSMC)"; break;
            case 86: dataCentre = "Helsinki"; break;
            case 87: dataCentre = "Belgrade"; break;
            case 88: dataCentre = "Oslo"; break;
            case 89: dataCentre = "Prague"; break;
            case 90: dataCentre = "Episkopi"; break;
            case 91: dataCentre = "Ankara"; break;
            case 92: dataCentre = "Frankfurt/Main"; break;
            case 93: dataCentre = "London (WAFC)"; break;
            case 94: dataCentre = "Copenhagen"; break;
            case 95: dataCentre = "Rota"; break;
            case 96: dataCentre = "Athens"; break;
            case 97: dataCentre = "European Space Agency (ESA)"; break;
            case 98: dataCentre = "European Center for Medium-Range Weather Forecasts (ECMWF) (RSMC)"; break;
            case 99: dataCentre = "De Bilt"; break;
            case 100: dataCentre = "Brazzaville"; break;
            case 101: dataCentre = "Abidjan"; break;
            case 102: dataCentre = "Libya (NMC)"; break;
            case 103: dataCentre = "Madagascar (NMC)"; break;
            case 104: dataCentre = "Mauritius (NMC)"; break;
            case 105: dataCentre = "Niger (NMC)"; break;
            case 106: dataCentre = "Seychelles (NMC)"; break;
            case 107: dataCentre = "Uganda (NMC)"; break;
            case 108: dataCentre = "United Republic of Tanzania (NMC)"; break;
            case 109: dataCentre = "Zimbabwe (NMC)"; break;
            case 110: dataCentre = "Hong Kong, China"; break;
            case 111: dataCentre = "Afghanistan (NMC)"; break;
            case 112: dataCentre = "Bahrain (NMC)"; break;
            case 113: dataCentre = "Bangladesh (NMC)"; break;
            case 114: dataCentre = "Bhutan (NMC)"; break;
            case 115: dataCentre = "Cambodia (NMC)"; break;
            case 116: dataCentre = "Democratic People's Republic of Korea (NMC)"; break;
            case 117: dataCentre = "Islamic Republic of Iran (NMC)"; break;
            case 118: dataCentre = "Iraq (NMC)"; break;
            case 119: dataCentre = "Kazakhstan (NMC)"; break;
            case 120: dataCentre = "Kuwait (NMC)"; break;
            case 121: dataCentre = "Kyrgyzstan (NMC)"; break;
            case 122: dataCentre = "Lao People's Democratic Republic (NMC)"; break;
            case 123: dataCentre = "Macao, China"; break;
            case 124: dataCentre = "Maldives (NMC)"; break;
            case 125: dataCentre = "Myanmar (NMC)"; break;
            case 126: dataCentre = "Nepal (NMC)"; break;
            case 127: dataCentre = "Oman (NMC)"; break;
            case 128: dataCentre = "Pakistan (NMC)"; break;
            case 129: dataCentre = "Qatar (NMC)"; break;
            case 130: dataCentre = "Yemen (NMC)"; break;
            case 131: dataCentre = "Sri Lanka (NMC)"; break;
            case 132: dataCentre = "Tajikistan (NMC)"; break;
            case 133: dataCentre = "Turkmenistan (NMC)"; break;
            case 134: dataCentre = "United Arab Emirates (NMC)"; break;
            case 135: dataCentre = "Uzbekistan (NMC)"; break;
            case 136: dataCentre = "Vietnam (NMC)"; break;
            case 140: dataCentre = "Bolivia (Plurinational State of) (NMC)"; break;
            case 141: dataCentre = "Guyana (NMC)"; break;
            case 142: dataCentre = "Paraguay (NMC)"; break;
            case 143: dataCentre = "Suriname (NMC)"; break;
            case 144: dataCentre = "Uruguay (NMC)"; break;
            case 145: dataCentre = "French Guiana"; break;
            case 146: dataCentre = "Brazilian Navy Hydrographic Center"; break;
            case 147: dataCentre = "National Commission on Space Activities (CONAE) - Argentina"; break;
            case 148: dataCentre = "Brazilian Department of Airspace Control - DECEA"; break;
            case 150: dataCentre = "Antigua and Barbuda (NMC)"; break;
            case 151: dataCentre = "Bahamas (NMC)"; break;
            case 152: dataCentre = "Barbados (NMC)"; break;
            case 153: dataCentre = "Belize (NMC)"; break;
            case 154: dataCentre = "British Caribbean Territories Center"; break;
            case 155: dataCentre = "San José"; break;
            case 156: dataCentre = "Cuba (NMC)"; break;
            case 157: dataCentre = "Dominica (NMC)"; break;
            case 158: dataCentre = "Dominican Republic (NMC)"; break;
            case 159: dataCentre = "El Salvador (NMC)"; break;
            case 160: dataCentre = "US NOAA/NESDIS"; break;
            case 161: dataCentre = "US NOAA Office of Oceanic and Atmospheric Research"; break;
            case 162: dataCentre = "Guatemala (NMC)"; break;
            case 163: dataCentre = "Haiti (NMC)"; break;
            case 164: dataCentre = "Honduras (NMC)"; break;
            case 165: dataCentre = "Jamaica (NMC)"; break;
            case 166: dataCentre = "Mexico City"; break;
            case 167: dataCentre = "Curaçao and Sint Maarten (NMC)"; break;
            case 168: dataCentre = "Nicaragua (NMC)"; break;
            case 169: dataCentre = "Panama (NMC)"; break;
            case 170: dataCentre = "Saint Lucia (NMC)"; break;
            case 171: dataCentre = "Trinidad and Tobago (NMC)"; break;
            case 172: dataCentre = "French Departments in RA IV"; break;
            case 173: dataCentre = "US National Aeronautics and Space Administration (NASA)"; break;
            case 174: dataCentre = "Integrated Science Data Management/Marine Environmental Data Service (ISDM/MEDS) - Canada"; break;
            case 175: dataCentre = "University Corporation for Atmospheric Research (UCAR) - United States"; break;
            case 176: dataCentre = "Cooperative Institute for Meteorological Satellite Studies (CIMSS) - United States"; break;
            case 177: dataCentre = "NOAA National Ocean Service - United States"; break;
            case 178: dataCentre = "Spire Global, Inc."; break;
            case 179: dataCentre = "GeoOptics, Inc."; break;
            case 180: dataCentre = "PlanetiQ"; break;
            case 181: dataCentre = "Atmospheric and Environmental Research (AER)"; break;
            case 182: dataCentre = "tomorrow.io"; break;
            case 183: dataCentre = "Scripps Institute of Oceanography (UC San Diego - United States)"; break;
            case 190: dataCentre = "Cook Islands (NMC)"; break;
            case 191: dataCentre = "French Polynesia (NMC)"; break;
            case 192: dataCentre = "Tonga (NMC)"; break;
            case 193: dataCentre = "Vanuatu (NMC)"; break;
            case 194: dataCentre = "Brunei Darussalam (NMC)"; break;
            case 195: dataCentre = "Indonesia (NMC)"; break;
            case 196: dataCentre = "Kiribati (NMC)"; break;
            case 197: dataCentre = "Federated States of Micronesia (NMC)"; break;
            case 198: dataCentre = "New Caledonia (NMC)"; break;
            case 199: dataCentre = "Niue"; break;
            case 200: dataCentre = "Papua New Guinea (NMC)"; break;
            case 201: dataCentre = "Philippines (NMC)"; break;
            case 202: dataCentre = "Samoa (NMC)"; break;
            case 203: dataCentre = "Solomon Islands (NMC)"; break;
            case 204: dataCentre = "National Institute of Water and Atmospheric Research (NIWA - New Zealand)"; break;
            case 205: dataCentre = "Tianmu"; break;
            case 210: dataCentre = "Frascati (ESA/ESRIN)"; break;
            case 211: dataCentre = "Lannion"; break;
            case 212: dataCentre = "Lisbon"; break;
            case 213: dataCentre = "Reykjavik"; break;
            case 214: dataCentre = "Madrid"; break;
            case 215: dataCentre = "Zurich"; break;
            case 216: dataCentre = "Service ARGOS - Toulouse"; break;
            case 217: dataCentre = "Bratislava"; break;
            case 218: dataCentre = "Budapest"; break;
            case 219: dataCentre = "Ljubljana"; break;
            case 220: dataCentre = "Warsaw"; break;
            case 221: dataCentre = "Zagreb"; break;
            case 222: dataCentre = "Albania (NMC)"; break;
            case 223: dataCentre = "Armenia (NMC)"; break;
            case 224: dataCentre = "Austria (NMC)"; break;
            case 225: dataCentre = "Azerbaijan (NMC)"; break;
            case 226: dataCentre = "Belarus (NMC)"; break;
            case 227: dataCentre = "Belgium (NMC)"; break;
            case 228: dataCentre = "Bosnia and Herzegovina (NMC)"; break;
            case 229: dataCentre = "Bulgaria (NMC)"; break;
            case 230: dataCentre = "Cyprus (NMC)"; break;
            case 231: dataCentre = "Estonia (NMC)"; break;
            case 232: dataCentre = "Georgia (NMC)"; break;
            case 233: dataCentre = "Dublin"; break;
            case 234: dataCentre = "Israel (NMC)"; break;
            case 235: dataCentre = "Jordan (NMC)"; break;
            case 236: dataCentre = "Latvia (NMC)"; break;
            case 237: dataCentre = "Lebanon (NMC)"; break;
            case 238: dataCentre = "Lithuania (NMC)"; break;
            case 239: dataCentre = "Luxembourg"; break;
            case 240: dataCentre = "Malta (NMC)"; break;
            case 241: dataCentre = "Monaco"; break;
            case 242: dataCentre = "Romania (NMC)"; break;
            case 243: dataCentre = "Syrian Arab Republic (NMC)"; break;
            case 244: dataCentre = "The former Yugoslav Republic of Macedonia (NMC)"; break;
            case 245: dataCentre = "Ukraine (NMC)"; break;
            case 246: dataCentre = "Republic of Moldova (NMC)"; break;
            case 247: dataCentre = "Operational Programme for the Exchange of weather RAdar information (OPERA) - EUMETNET"; break;
            case 248: dataCentre = "Montenegro (NMC)"; break;
            case 249: dataCentre = "Barcelona Dust Forecast Center"; break;
            case 250: dataCentre = "COnsortium for Small scale MOdelling (COSMO)"; break;
            case 251: dataCentre = "Meteorological Cooperation on Operational NWP (MetCoOp)"; break;
            case 252: dataCentre = "Max Planck Institute for Meteorology (MPI-M)"; break;
            case 253: dataCentre = "Alfred Wegener Institute"; break;
            case 254: dataCentre = "EUMETSAT Operation Center"; break;
            case 255: dataCentre = "Not to be Used"; break;
            case 256: dataCentre = "Angola (NMC)"; break;
            case 257: dataCentre = "Benin (NMC)"; break;
            case 258: dataCentre = "Botswana (NMC)"; break;
            case 259: dataCentre = "Burkina Faso (NMC)"; break;
            case 260: dataCentre = "Burundi (NMC)"; break;
            case 261: dataCentre = "Cameroon (NMC)"; break;
            case 262: dataCentre = "Cabo Verde (NMC)"; break;
            case 263: dataCentre = "Central African Republic (NMC)"; break;
            case 264: dataCentre = "Chad (NMC)"; break;
            case 265: dataCentre = "Comoros (NMC)"; break;
            case 266: dataCentre = "Democratic Republic of the Congo (NMC)"; break;
            case 267: dataCentre = "Djibouti (NMC)"; break;
            case 268: dataCentre = "Eritrea (NMC)"; break;
            case 269: dataCentre = "Ethiopia (NMC)"; break;
            case 270: dataCentre = "Gabon (NMC)"; break;
            case 271: dataCentre = "The Gambia (NMC)"; break;
            case 272: dataCentre = "Ghana (NMC)"; break;
            case 273: dataCentre = "Guinea (NMC)"; break;
            case 274: dataCentre = "Guinea-Bissau (NMC)"; break;
            case 275: dataCentre = "Lesotho (NMC)"; break;
            case 276: dataCentre = "Liberia (NMC)"; break;
            case 277: dataCentre = "Malawi (NMC)"; break;
            case 278: dataCentre = "Mali (NMC)"; break;
            case 279: dataCentre = "Mauritania (NMC)"; break;
            case 280: dataCentre = "Namibia (NMC)"; break;
            case 281: dataCentre = "Nigeria (NMC)"; break;
            case 282: dataCentre = "Rwanda (NMC)"; break;
            case 283: dataCentre = "São Tomé and Príncipe (NMC)"; break;
            case 284: dataCentre = "Sierra Leone (NMC)"; break;
            case 285: dataCentre = "Somalia (NMC)"; break;
            case 286: dataCentre = "Sudan (NMC)"; break;
            case 287: dataCentre = "Eswatini (NMC)"; break;
            case 288: dataCentre = "Togo (NMC)"; break;
            case 289: dataCentre = "Zambia (NMC)"; break;
            case 290: dataCentre = "EUMETNET E-Profile"; break;
            case 291: dataCentre = "Institute of Atmospheric Physics (IAP) of the Chinese Academy of Sciences (CAS)"; break;
            case 292: dataCentre = "Helmholtz Centre for Environmental Research (UFZ)"; break;
            case 293: dataCentre = "University of Bremen"; break;
            case 294: dataCentre = "Netherlands Institute for Space Research (SRON)"; break;
            case 295: dataCentre = "Royal Belgian Institute for Space Aeronomy (BIRA-IASB)"; break;
            case 296: dataCentre = "French National Centre for Scientific Research (CNRS)"; break;
            case 297: dataCentre = "Nanjing Institute of Environmental Sciences (NIES)"; break;
            case 298: dataCentre = "Dynamic Meteorology Laboratory (LMD)"; break;
            case 299: dataCentre = "The Rutherford Appleton Laboratory (RAL)"; break;
            case 300: dataCentre = "Greek Atomic Energy Commission (Greece)"; break;
            case 301: dataCentre = "United States Environmental Protection Agency (USA)"; break;
            case 302: dataCentre = "Australian Radiation Protection and Nuclear Safety (Australia)"; break;
            case 303: dataCentre = "Authority for Nuclear Safety and Radiation Protection (Kingdom of the Netherlands)"; break;
            case 304: dataCentre = "Autorité de sûreté nucléaire (France)"; break;
            case 305: dataCentre = "Bundesamt für Strahlenschutz (Germany)"; break;
            case 306: dataCentre = "National Commission for Nuclear Activities Control (Romania)"; break;
            case 307: dataCentre = "Consejo de Seguridad Nuclear (Spain)"; break;
            case 308: dataCentre = "Danish Emergency Management Agency (Denmark)"; break;
            case 309: dataCentre = "Norwegian Radiation Protection Agency (Norway)"; break;
            case 310: dataCentre = "Federal Agency for Nuclear Control (Belgium)"; break;
            case 311: dataCentre = "Institute of Radiation Protection and Dosimetry (Brazil)"; break;
            case 312: dataCentre = "National Inspectorate for Nuclear Safety and Radiation Protection (Italy)"; break;
            case 313: dataCentre = "Nuclear Regulatory Authority (Turkey)"; break;
            case 314: dataCentre = "Nuclear Regulation Authority (Japan)"; break;
            case 315: dataCentre = "Nuclear Regulatory Authority (Bulgaria)"; break;
            case 316: dataCentre = "Ukrainian Radiation Protection Institute (Ukraine)"; break;
            case 317: dataCentre = "Health Canada Radio Protection Bureau (Canada)"; break;
            case 318: dataCentre = "Portuguese Society for Radiation Protection (Portugal)"; break;
            case 319: dataCentre = "Swedish Radiation Safety Authority (Sweden)"; break;
            case 320: dataCentre = "Radiation and Nuclear Safety Authority (Finland)"; break;
            case 321: dataCentre = "State Office for Nuclear Safety (Czech Republic)"; break;
            case 322: dataCentre = "Nuclear Regulation Authority (Slovakia)"; break;
            case 323: dataCentre = "Weather Prediction Model Intercomparison Project (WP-MIP)"; break;
            case 65535: dataCentre = "Missing Value"; break;
          }
          _println(dataCentre);
          ...
          if (this.DisciplineOfProcessedData == 0) { // Meteorological
            if (this.CategoryOfParametersByProductDiscipline == 0) { // Temperature
              switch (this.ParameterNumberByProductDisciplineAndParameterCategory) {
                ...
                case 21: this.ParameterNameAndUnit = "Apparent Temperature(K)"; break;
                case 22: this.ParameterNameAndUnit = "Temperature Tendency due to Shortwave Radiation(K s-1)"; break;
                case 23: this.ParameterNameAndUnit = "Temperature Tendency due to Longwave Radiation(K s-1)"; break;
                case 24: this.ParameterNameAndUnit = "Temperature Tendency due to Shortwave Radiation, Clear Sky(K s-1)"; break;
                case 25: this.ParameterNameAndUnit = "Temperature Tendency due to Longwave Radiation, Clear Sky(K s-1)"; break;
                case 26: this.ParameterNameAndUnit = "Temperature Tendency due to parameterizations(K s-1)"; break;
                case 27: this.ParameterNameAndUnit = "Wet-Bulb Temperature(K)"; break;
                case 28: this.ParameterNameAndUnit = "Unbalanced Component of Temperature(K)"; break;
                case 29: this.ParameterNameAndUnit = "Temperature Advection(K s-1)"; break;
                case 30: this.ParameterNameAndUnit = "Latent Heat Net Flux Due to Evaporation(W m-2)"; break;
                case 31: this.ParameterNameAndUnit = "Latent Heat Net Flux Due to Sublimation(W m-2)"; break;
                case 32: this.ParameterNameAndUnit = "Wet-Bulb Potential Temperature(K)"; break;
              ...
              switch (this.ParameterNumberByProductDisciplineAndParameterCategory) {
                ...
                case 93: this.ParameterNameAndUnit = "Relative Humidity With Respect to Water(%)"; break;
                case 94: this.ParameterNameAndUnit = "Relative Humidity With Respect to Ice(%)"; break;
                case 95: this.ParameterNameAndUnit = "Freezing or Frozen Precipitation Rate(kg m-2 s-1)"; break;
                case 96: this.ParameterNameAndUnit = "Mass Density of Rain(kg m-3)"; break;
                case 97: this.ParameterNameAndUnit = "Mass Density of Snow(kg m-3)"; break;
                case 98: this.ParameterNameAndUnit = "Mass Density of Graupel(kg m-3)"; break;
                case 99: this.ParameterNameAndUnit = "Mass Density of Hail(kg m-3)"; break;
                case 100: this.ParameterNameAndUnit = "Specific Number Concentration of Rain(kg-1)"; break;
                case 101: this.ParameterNameAndUnit = "Specific Number Concentration of Snow(kg-1)"; break;
                case 102: this.ParameterNameAndUnit = "Specific Number Concentration of Graupel(kg-1)"; break;
                case 103: this.ParameterNameAndUnit = "Specific Number Concentration of Hail(kg-1)"; break;
                case 104: this.ParameterNameAndUnit = "Number Density of Rain(m-3)"; break;
                case 105: this.ParameterNameAndUnit = "Number Density of Snow(m-3)"; break;
                case 106: this.ParameterNameAndUnit = "Number Density of Graupel(m-3)"; break;
                case 107: this.ParameterNameAndUnit = "Number Density of Hail(m-3)"; break;
                case 108: this.ParameterNameAndUnit = "Specific Humidity Tendency due to Parameterizations(kg kg-1 s-1)"; break;
                case 109: this.ParameterNameAndUnit = "Mass Density of Liquid Water Coating on Hail Expressed as Mass of Liquid Water per Unit Volume of Air(kg m-3)"; break;
                case 110: this.ParameterNameAndUnit = "Specific Mass of Liquid Water Coating on Hail Expressed as Mass of Liquid Water per Unit Mass of Moist Air(kg kg-1)"; break;
                case 111: this.ParameterNameAndUnit = "Mass Mixing Ratio of Liquid Water Coating on Hail Expressed as Mass of Liquid Water per Unit Mass of Dry Air(kg kg-1)"; break;
                case 112: this.ParameterNameAndUnit = "Mass Density of Liquid Water Coating on Graupel Expressed as Mass of Liquid Water per Unit Volume of Air(kg m-3)"; break;
                case 113: this.ParameterNameAndUnit = "Specific Mass of Liquid Water Coating on Graupel Expressed as Mass of Liquid Water per Unit Mass of Moist Air(kg kg-1)"; break;
                case 114: this.ParameterNameAndUnit = "Mass Mixing Ratio of Liquid Water Coating on Graupel Expressed as Mass of Liquid Water per Unit Mass of Dry Air(kg kg-1)"; break;
                case 115: this.ParameterNameAndUnit = "Mass Density of Liquid Water Coating on Snow Expressed as Mass of Liquid Water per Unit Volume of Air(kg m-3)"; break;
                case 116: this.ParameterNameAndUnit = "Specific Mass of Liquid Water Coating on Snow Expressed as Mass of Liquid Water per Unit Mass of Moist Air(kg kg-1)"; break;
                case 117: this.ParameterNameAndUnit = "Mass Mixing Ratio of Liquid Water Coating on Snow Expressed as Mass of Liquid Water per Unit Mass of Dry Air(kg kg-1)"; break;
                case 118: this.ParameterNameAndUnit = "Unbalanced Component of Specific Humidity(kg kg-1)"; break;
                case 119: this.ParameterNameAndUnit = "Unbalanced Component of Specific Cloud Liquid Water content(kg kg-1)"; break;
                case 120: this.ParameterNameAndUnit = "Unbalanced Component of Specific Cloud Ice Water content(kg kg-1)"; break;
                case 121: this.ParameterNameAndUnit = "Fraction of Snow Cover(Proportion)"; break;
                case 122: this.ParameterNameAndUnit = "Precipitation intensity index(See Table 4.247)"; break;
                case 123: this.ParameterNameAndUnit = "Dominant precipitation type(See Table 4.201)"; break;
                case 124: this.ParameterNameAndUnit = "Presence of showers(See Table 4.222)"; break;
                case 125: this.ParameterNameAndUnit = "Presence of blowing snow(See Table 4.222)"; break;
                case 126: this.ParameterNameAndUnit = "Presence of blizzard(See Table 4.222)"; break;
                case 127: this.ParameterNameAndUnit = "Ice pellets (non-water equivalent) precipitation rate(m s-1)"; break;
                case 128: this.ParameterNameAndUnit = "Total solid precipitation rate(kg m-2 s-1)"; break;
                case 129: this.ParameterNameAndUnit = "Effective Radius of Cloud Water(m)"; break;
                case 130: this.ParameterNameAndUnit = "Effective Radius of Rain(m)"; break;
                case 131: this.ParameterNameAndUnit = "Effective Radius of Cloud Ice(m)"; break;
                case 132: this.ParameterNameAndUnit = "Effective Radius of Snow(m)"; break;
                case 133: this.ParameterNameAndUnit = "Effective Radius of Graupel(m)"; break;
                case 134: this.ParameterNameAndUnit = "Effective Radius of Hail(m)"; break;
                case 135: this.ParameterNameAndUnit = "Effective Radius of Subgrid Liquid Clouds(m)"; break;
                case 136: this.ParameterNameAndUnit = "Effective Radius of Subgrid Ice Clouds(m)"; break;
                case 137: this.ParameterNameAndUnit = "Effective Aspect Ratio of Rain)"; break;
                case 138: this.ParameterNameAndUnit = "Effective Aspect Ratio of Cloud Ice)"; break;
                case 139: this.ParameterNameAndUnit = "Effective Aspect Ratio of Snow)"; break;
                case 140: this.ParameterNameAndUnit = "Effective Aspect Ratio of Graupel)"; break;
                case 141: this.ParameterNameAndUnit = "Effective Aspect Ratio of Hail)"; break;
                case 142: this.ParameterNameAndUnit = "Effective Aspect Ratio of Subgrid Ice Clouds)"; break;
                case 143: this.ParameterNameAndUnit = "Potential evaporation rate(kg m-2 s-1)"; break;
                case 144: this.ParameterNameAndUnit = "Specific rain water content (convective)(kg kg-1)"; break;
                case 145: this.ParameterNameAndUnit = "Specific snow water content (convective)(kg kg-1)"; break;
                case 146: this.ParameterNameAndUnit = "Cloud ice precipitation rate(kg m-2 s-1)"; break;
                case 147: this.ParameterNameAndUnit = "Character of precipitation(See Table 4.249)"; break;
                case 148: this.ParameterNameAndUnit = "Snow evaporation rate(kg m-2 s-1)"; break;
                case 149: this.ParameterNameAndUnit = "Cloud water mixing ratio(kg kg-1)"; break;
                case 150: this.ParameterNameAndUnit = "Column integrated eastward water vapor mass flux(kg m-1s-1)"; break;
                case 151: this.ParameterNameAndUnit = "Column integrated northward water vapor mass flux(kg m-1s-1)"; break;
                case 152: this.ParameterNameAndUnit = "Column integrated eastward cloud liquid water mass flux(kg m-1s-1)"; break;
                case 153: this.ParameterNameAndUnit = "Column integrated northward cloud liquid water mass flux(kg m-1s-1)"; break;
                case 154: this.ParameterNameAndUnit = "Column integrated eastward cloud ice mass flux(kg m-1s-1)"; break;
                case 155: this.ParameterNameAndUnit = "Column integrated northward cloud ice mass flux(kg m-1s-1)"; break;
                case 156: this.ParameterNameAndUnit = "Column integrated eastward rain mass flux(kg m-1s-1)"; break;
                case 157: this.ParameterNameAndUnit = "Column integrated northward rain mass flux(kg m-1s-1)"; break;
                case 158: this.ParameterNameAndUnit = "Column integrated eastward snow mass flux(kg m-1s-1)"; break;
                case 159: this.ParameterNameAndUnit = "Column integrated northward snow mass flux(kg m-1s-1)"; break;
                case 160: this.ParameterNameAndUnit = "Column integrated divergence of water vapor mass flux(kg m-1s-1)"; break;
                case 161: this.ParameterNameAndUnit = "Column integrated divergence of cloud liquid water mass flux(kg m-1s-1)"; break;
                case 162: this.ParameterNameAndUnit = "Column integrated divergence of cloud ice mass flux(kg m-1s-1)"; break;
                case 163: this.ParameterNameAndUnit = "Column integrated divergence of rain mass flux(kg m-1s-1)"; break;
                case 164: this.ParameterNameAndUnit = "Column integrated divergence of snow mass flux(kg m-1s-1)"; break;
                case 165: this.ParameterNameAndUnit = "Column integrated divergence of total water mass flux(kg m-1s-1)"; break;
                case 166: this.ParameterNameAndUnit = "Column integrated water vapor flux(kg m-1s-1)"; break;
                case 167: this.ParameterNameAndUnit = "Total column supercooled liquid water(kg m-2)"; break;
                case 168: this.ParameterNameAndUnit = "Saturation specific humidity with respect to water(kg m-3)"; break;
                case 169: this.ParameterNameAndUnit = "Total column integrated saturation specific humidity with respect to water(kg m-2)"; break;
                case 170: this.ParameterNameAndUnit = "Mean Mass Diameter of Hail(m)"; break;
                case 171: this.ParameterNameAndUnit = "Estimated Maximum Diameter of Hail(m)"; break;
                ...
                case 228: this.ParameterNameAndUnit = "Flat Ice Accumulation (FRAM)(kg m-2)"; break;
                case 229: this.ParameterNameAndUnit = "Line Ice Accumulation (FRAM)(kg m-2)"; break;
                case 230: this.ParameterNameAndUnit = "Sleet Accumulation(kg m-2)"; break;
                case 231: this.ParameterNameAndUnit = "Precipitation Potential Index(%)"; break;
                case 232: this.ParameterNameAndUnit = "Probability Cloud Ice Present(%)"; break;
                case 233: this.ParameterNameAndUnit = "Snow Liquid Ratio(kg kg-1)"; break;
                case 234: this.ParameterNameAndUnit = "Precipitation Duration(hour)"; break;
                case 235: this.ParameterNameAndUnit = "Cloud Liquid Mixing Ratio(kg kg-1)"; break;
                case 236: this.ParameterNameAndUnit = "Hail Accumulation(m)"; break;
                case 237: this.ParameterNameAndUnit = "Total Column Integrated Precipitation(kg m-2)"; break;
                case 238: this.ParameterNameAndUnit = "Hourly Maximum of 1-minute Average Precipitation Rate(kg m-2 s-1)"; break;
                case 239: this.ParameterNameAndUnit = "Hourly Maximum of 5-minute Average Precipitation Rate(kg m-2 s-1)"; break;
                case 240: this.ParameterNameAndUnit = "Hourly Maximum of 10-minute Average Precipitation Rate(kg m-2 s-1)"; break;
                ...
                case 245: this.ParameterNameAndUnit = "Hourly Maximum of Column Vertical Integrated Graupel on Entire Atmosphere(kg m-2)"; break;
                case 255: this.ParameterNameAndUnit = "Missing"; break;
                default : this.ParameterNameAndUnit = nf(this.ParameterNumberByProductDisciplineAndParameterCategory, 0); break;
              }
            }
              ...
              switch (this.ParameterNumberByProductDisciplineAndParameterCategory) {
                ...
                case 36: this.ParameterNameAndUnit = "Amplitude Function for Rossby Wave Envelope for Meridional Wind(m s-1)"; break;
                case 37: this.ParameterNameAndUnit = "Northward Turbulent Surface Stress(N m-2 s)"; break;
                case 38: this.ParameterNameAndUnit = "Eastward Turbulent Surface Stress(N m-2 s)"; break;
                case 39: this.ParameterNameAndUnit = "Eastward Wind Tendency Due to Parameterizations(m s-2)"; break;
                case 40: this.ParameterNameAndUnit = "Northward Wind Tendency Due to Parameterizations(m s-2)"; break;
                case 41: this.ParameterNameAndUnit = "U-Component of Geostrophic Wind(m s-1)"; break;
                case 42: this.ParameterNameAndUnit = "V-Component of Geostrophic Wind(m s-1)"; break;
                case 43: this.ParameterNameAndUnit = "Geostrophic Wind Direction(°)"; break;
                case 44: this.ParameterNameAndUnit = "Geostrophic Wind Speed(m s-1)"; break;
                case 45: this.ParameterNameAndUnit = "Unbalanced Component of Divergence(s-1)"; break;
                case 46: this.ParameterNameAndUnit = "Vorticity Advection(s-2)"; break;
                case 47: this.ParameterNameAndUnit = "Surface roughness for heat(m)"; break;
                case 48: this.ParameterNameAndUnit = "Surface roughness for moisture(m)"; break;
                case 49: this.ParameterNameAndUnit = "Wind stress(N m-2)"; break;
                case 50: this.ParameterNameAndUnit = "Eastward wind stress(N m-2)"; break;
                case 51: this.ParameterNameAndUnit = "Northward wind stress(N m-2)"; break;
                case 52: this.ParameterNameAndUnit = "U-component of wind stress(N m-2)"; break;
                case 53: this.ParameterNameAndUnit = "V-component of wind stress(N m-2)"; break;
                case 54: this.ParameterNameAndUnit = "Natural logarithm of surface roughness length for heat(m)"; break;
                case 55: this.ParameterNameAndUnit = "Natural logarithm of surface roughness length for moisture(m)"; break;
                case 56: this.ParameterNameAndUnit = "U-component of neutral wind(m s-1)"; break;
                case 57: this.ParameterNameAndUnit = "V-component of neutral wind(m s-1)"; break;
                case 58: this.ParameterNameAndUnit = "Magnitude of turbulent surface stress(N m-2)"; break;
                case 59: this.ParameterNameAndUnit = "Vertical divergence(s-1)"; break;
                case 60: this.ParameterNameAndUnit = "Drag thermal coefficient(Numeric)"; break;
                case 61: this.ParameterNameAndUnit = "Drag evaporation coefficient(Numeric)"; break;
                case 62: this.ParameterNameAndUnit = "Eastward turbulent surface stress(N m-2)"; break;
                case 63: this.ParameterNameAndUnit = "Northward turbulent surface stress(N m-2)"; break;
                case 64: this.ParameterNameAndUnit = "Eastward turbulent surface stress due to orographic form drag(N m-2)"; break;
                case 65: this.ParameterNameAndUnit = "Northward turbulent surface stress due to orographic form drag(N m-2)"; break;
                case 66: this.ParameterNameAndUnit = "Eastward turbulent surface stress due to surface roughness(N m-2)"; break;
                case 67: this.ParameterNameAndUnit = "Northward turbulent surface stress due to surface roughness(N m-2)"; break;
                case 68: this.ParameterNameAndUnit = "Convective Gust(m s-1)"; break;
                case 69: this.ParameterNameAndUnit = "Turbulent Gust(m s-1)"; break;
                case 70: this.ParameterNameAndUnit = "Wind Speed Threshold for Wind Erosion(m)"; break;
                ...
                case 225: this.ParameterNameAndUnit = "Transport Wind Speed(m s-1)"; break;
                case 226: this.ParameterNameAndUnit = "Transport Wind Direction(Deg)"; break;
                case 227: this.ParameterNameAndUnit = "Earliest Reasonable Arrival Time (10% exceedance)(s)"; break;
                case 228: this.ParameterNameAndUnit = "Most Likely Arrival Time (50% exceedance)(s)"; break;
                case 229: this.ParameterNameAndUnit = "Most Likely Departure Time (50% exceedance)(s)"; break;
                case 230: this.ParameterNameAndUnit = "Latest Reasonable Departure Time (90% exceedance)(s)"; break;
                case 231: this.ParameterNameAndUnit = "Tropical Wind Direction(°)"; break;
                case 232: this.ParameterNameAndUnit = "Tropical Wind Speed(m s-1)"; break;
                case 233: this.ParameterNameAndUnit = "Effective Layer Bulk Shear Magnitude (Inflow Base to 50% of EL)(kt)"; break;
                case 234: this.ParameterNameAndUnit = "U Component Effective Layer Bulk Shear (Inflow Base to 50% of EL)(kt)"; break;
                case 235: this.ParameterNameAndUnit = "V Component Effective Layer Bulk Shear (Inflow Base to 50% of EL)(kt)"; break;
                case 236: this.ParameterNameAndUnit = "U Component Bunkers Effective Right Motion(kt)"; break;
                case 237: this.ParameterNameAndUnit = "V Component Bunkers Effective Right Motion(kt)"; break;
                case 255: this.ParameterNameAndUnit = "Missing"; break;
                default : this.ParameterNameAndUnit = nf(this.ParameterNumberByProductDisciplineAndParameterCategory, 0); break;
              }
            }
              ...
              switch (this.ParameterNumberByProductDisciplineAndParameterCategory) {
                ...
                case 27: this.ParameterNameAndUnit = "Updraught Mass Flux(kg m-2 s-1)"; break;
                case 28: this.ParameterNameAndUnit = "Downdraught Mass Flux(kg m-2 s-1)"; break;
                case 29: this.ParameterNameAndUnit = "Updraught Detrainment Rate(kg m-3 s-1)"; break;
                case 30: this.ParameterNameAndUnit = "Downdraught Detrainment Rate(kg m-3 s-1)"; break;
                case 31: this.ParameterNameAndUnit = "Unbalanced Component of Logarithm of Surface Pressure(-)"; break;
                case 32: this.ParameterNameAndUnit = "Saturation water vapour pressure(Pa)"; break;
                case 33: this.ParameterNameAndUnit = "Geometric altitude above mean sea level(m)"; break;
                case 34: this.ParameterNameAndUnit = "Geometric height above ground level(m)"; break;
                case 35: this.ParameterNameAndUnit = "Column integrated divergence of total mass flux(kg m-2 s-1)"; break;
                case 36: this.ParameterNameAndUnit = "Column integrated eastward total mass flux(kg m-2 s-1)"; break;
                case 37: this.ParameterNameAndUnit = "Column integrated northward total mass flux(kg m-2 s-1)"; break;
                case 38: this.ParameterNameAndUnit = "Standard deviation of filtered subgrid orography(m)"; break;
                case 39: this.ParameterNameAndUnit = "Column integrated mass of atmosphere(kg m-2 s-1)"; break;
                case 40: this.ParameterNameAndUnit = "Column integrated eastward geopotential flux(W m-1)"; break;
                case 41: this.ParameterNameAndUnit = "Column integrated northward geopotential flux(W m-1)"; break;
                case 42: this.ParameterNameAndUnit = "Column integrated divergence of water geopotential flux(W m-2)"; break;
                case 43: this.ParameterNameAndUnit = "Column integrated divergence of geopotential flux(W m-2)"; break;
                case 44: this.ParameterNameAndUnit = "Height of zero-degree wet-bulb temperature(m)"; break;
                case 45: this.ParameterNameAndUnit = "Height of one-degree wet-bulb temperature(m)"; break;
                case 46: this.ParameterNameAndUnit = "Pressure departure from hydrostatic state(Pa)"; break;
                ...
                case 213: this.ParameterNameAndUnit = "Orographic Convexity"; break;
                case 214: this.ParameterNameAndUnit = "Orographic Asymmetry, W Component"; break;
                case 215: this.ParameterNameAndUnit = "Orographic Asymmetry, S Component"; break;
                case 216: this.ParameterNameAndUnit = "Orographic Asymmetry, SW Component"; break;
                case 217: this.ParameterNameAndUnit = "Orographic Asymmetry, NW Component"; break;
                case 218: this.ParameterNameAndUnit = "Orographic Length Scale, W Component"; break;
                case 219: this.ParameterNameAndUnit = "Orographic Length Scale, S Component"; break;
                case 220: this.ParameterNameAndUnit = "Orographic Length Scale, SW Component"; break;
                case 221: this.ParameterNameAndUnit = "Orographic Length Scale, NW Component"; break;
                case 222: this.ParameterNameAndUnit = "Effective Surface Height(m)"; break;
                case 255: this.ParameterNameAndUnit = "Missing"; break;
                default : this.ParameterNameAndUnit = nf(this.ParameterNumberByProductDisciplineAndParameterCategory, 0); break;
              }
            }
              ...
              switch (this.ParameterNumberByProductDisciplineAndParameterCategory) {
                ...
                case 16: this.ParameterNameAndUnit = "Bulk Richardson Number(Numeric)"; break;
                case 17: this.ParameterNameAndUnit = "Gradient Richardson Number(Numeric)"; break;
                case 18: this.ParameterNameAndUnit = "Flux Richardson Number(Numeric)"; break;
                case 19: this.ParameterNameAndUnit = "Convective Available Potential Energy - Shear(m2 s-2)"; break;
                case 20: this.ParameterNameAndUnit = "Thunderstorm Intensity Index(See Table 4.246"; break;
                case 21: this.ParameterNameAndUnit = "Storm Severity Index(Numeric(SSI)"; break;
                case 22: this.ParameterNameAndUnit = "Reciprocal Obukhov Length(m-1)"; break;
                case 23: this.ParameterNameAndUnit = "Storm Relative Helicity - Right Moving Storm(J kg-1)"; break;
                case 24: this.ParameterNameAndUnit = "Storm Relative Helicity - Left Moving Storm(J kg-1)"; break;
                case 25: this.ParameterNameAndUnit = "Effective Storm Relative Helicity - Mean Flow(J kg-1)"; break;
                case 26: this.ParameterNameAndUnit = "Effective Storm Relative Helicity - Right Moving Storm(J kg-1)"; break;
                case 27: this.ParameterNameAndUnit = "Effective Storm Relative Helicity - Left Moving Storm(J kg-1)"; break;
                ...
                case 200: this.ParameterNameAndUnit = "Hourly Minimum of Updraft Helicity(m2 s-2)"; break;
                case 201: this.ParameterNameAndUnit = "Bourgoiun Negative Energy Layer (surface to freezing level)(J kg-1)"; break;
                case 202: this.ParameterNameAndUnit = "Bourgoiun Positive Energy Layer (2k ft AGL to 400 hPa)(J kg-1)"; break;
                case 203: this.ParameterNameAndUnit = "Downdraft CAPE(J kg-1)"; break;
                case 204: this.ParameterNameAndUnit = "Effective Storm Relative Helicity(m2 s-2)"; break;
                case 205: this.ParameterNameAndUnit = "Enhanced Stretching Potential(Numeric)"; break;
                case 206: this.ParameterNameAndUnit = "Critical Angle(Degree)"; break;
                case 207: this.ParameterNameAndUnit = "Effective Surface Helicity(m2 s-2)"; break;
                case 208: this.ParameterNameAndUnit = "Significant Tornado Parameter with CIN - Effective Layer(numeric)"; break;
                case 209: this.ParameterNameAndUnit = "Significant Hail Parameter(numeric)"; break;
                case 210: this.ParameterNameAndUnit = "Supercell Composite Parameter - Effective Layer(numeric)"; break;
                case 211: this.ParameterNameAndUnit = "Significant Tornado Parameter - Fixed Layer(numeric)"; break;
                case 212: this.ParameterNameAndUnit = "Mixed Layer (100 mb) Virtual LFC(numeric)"; break;
                case 255: this.ParameterNameAndUnit = "Missing"; break;
                default : this.ParameterNameAndUnit = nf(this.ParameterNumberByProductDisciplineAndParameterCategory, 0); break;
              }
            }
              ...
              switch (this.ParameterNumberByProductDisciplineAndParameterCategory) {
                ...
                case 28: this.ParameterNameAndUnit = "Mountain Wave Turbulence (Eddy Dissipation Rate)(m2/3 s-1)"; break;
                case 29: this.ParameterNameAndUnit = "Clear Air Turbulence (CAT) (Eddy Dissipation Rate)(m2/3 s-1)"; break;
                case 30: this.ParameterNameAndUnit = "Eddy Dissipation Parameter(m2/3 s-1)"; break;
                case 31: this.ParameterNameAndUnit = "Maximum of Eddy Dissipation Parameter in Layer(m2/3 s-1)"; break;
                case 32: this.ParameterNameAndUnit = "Highest Freezing Level(m)"; break;
                case 33: this.ParameterNameAndUnit = "Visibility Through Liquid Fog(m)"; break;
                case 34: this.ParameterNameAndUnit = "Visibility Through Ice Fog(m)"; break;
                case 35: this.ParameterNameAndUnit = "Visibility Through Blowing Snow(m)"; break;
                case 36: this.ParameterNameAndUnit = "Presence of Snow Squalls(See Table 4.222)"; break;
                case 37: this.ParameterNameAndUnit = "Icing Severity(See Table 4.228)"; break;
                case 38: this.ParameterNameAndUnit = "Sky transparency index(See Table 4.214)"; break;
                case 39: this.ParameterNameAndUnit = "Seeing index(See Table 4.214)"; break;
                case 40: this.ParameterNameAndUnit = "Snow level(m)"; break;
                case 41: this.ParameterNameAndUnit = "Duct base height(m)"; break;
                case 42: this.ParameterNameAndUnit = "Trapping layer base height(m)"; break;
                case 43: this.ParameterNameAndUnit = "Trapping layer top height(m)"; break;
                case 44: this.ParameterNameAndUnit = "Mean vertical gradient of refractivity inside trapping layer(m-1)"; break;
                case 45: this.ParameterNameAndUnit = "Minimum vertical gradient of refractivity inside trapping layer(m-1)"; break;
                case 46: this.ParameterNameAndUnit = "Net radiation flux(W m-2)"; break;
                case 47: this.ParameterNameAndUnit = "Global irradiance on tilted surfaces(W m-2)"; break;
                case 48: this.ParameterNameAndUnit = "Top of persistent contrails(m)"; break;
                case 49: this.ParameterNameAndUnit = "Base of persistent contrails(m)"; break;
                case 50: this.ParameterNameAndUnit = "Convectively-induced turbulence (CIT) (eddy dissipation rate)(m2/3 s-1)"; break;
                case 51: this.ParameterNameAndUnit = "Visibility Through Precipitation(m)"; break;
                case 52: this.ParameterNameAndUnit = "Hail Kinetic Energy Flux(J m-2 s-1)"; break;
                ...
                case 223: this.ParameterNameAndUnit = "Tornado Conditional Intensity Groups(Numeric)"; break;
                case 224: this.ParameterNameAndUnit = "Hail Conditional Intensity Groups(Numeric)"; break;
                case 225: this.ParameterNameAndUnit = "Wind Conditional Intensity Groups(Numeric)"; break;
                case 226: this.ParameterNameAndUnit = "Total Severe Conditional Intensity Groups(Numeric)"; break;
                ...
                case 235: this.ParameterNameAndUnit = "Joint Fire Weather Probability(%)"; break;
                case 236: this.ParameterNameAndUnit = "Snow Level(m)"; break;
                case 237: this.ParameterNameAndUnit = "Dry Thunderstorm Probability(%)"; break;
                case 238: this.ParameterNameAndUnit = "Ellrod Index"; break;
                case 239: this.ParameterNameAndUnit = "Craven-Wiedenfeld Aggregate Severe Parameter(Numeric)"; break;
                case 240: this.ParameterNameAndUnit = "Continuous Icing Severity(non-dim)"; break;
                case 255: this.ParameterNameAndUnit = "Missing"; break;
                default : this.ParameterNameAndUnit = nf(this.ParameterNumberByProductDisciplineAndParameterCategory, 0); break;
              }
            }
              ...
              switch (this.ParameterNumberByProductDisciplineAndParameterCategory) {
                ...
                case 15: this.ParameterNameAndUnit = "Dry deposition velocity(m s-1)"; break;
                case 16: this.ParameterNameAndUnit = "Mass mixing ratio with respect to dry air(kg kg-1)"; break;
                case 17: this.ParameterNameAndUnit = "Mass mixing ratio with respect to wet air(kg kg-1)"; break;
                case 18: this.ParameterNameAndUnit = "Potential of hydrogen (pH)(pH)"; break;
                case 19: this.ParameterNameAndUnit = "Loss Rate Due to Reaction with Hydroxyl Radical (OH)(kg kg-1 s-1)"; break;
                case 20: this.ParameterNameAndUnit = "Photolysis Rate(s-1)"; break;
                case 21: this.ParameterNameAndUnit = "Emission Potential(kg m-2 s-1)"; break;
                ...
                case 60: this.ParameterNameAndUnit = "Aerosol Specific Number Concentration(kg-1)"; break;
                case 61: this.ParameterNameAndUnit = "Maximum of Mass Density(kg m-3)"; break;
                case 62: this.ParameterNameAndUnit = "Height of Mass Density(m)"; break;
                case 63: this.ParameterNameAndUnit = "Column-Averaged Mass Density in Layer(kg m-3)"; break;
                case 64: this.ParameterNameAndUnit = "Mole fraction with respect to dry air(mol mol-1)"; break;
                case 65: this.ParameterNameAndUnit = "Mole fraction with respect to wet air(mol mol-1)"; break;
                case 66: this.ParameterNameAndUnit = "Column-integrated in-cloud scavenging rate by precipitation(kg m-2 s-1)"; break;
                case 67: this.ParameterNameAndUnit = "Column-integrated below-cloud scavenging rate by precipitation(kg m-2 s-1)"; break;
                case 68: this.ParameterNameAndUnit = "Column-integrated release rate from evaporating precipitation(kg m-2 s-1)"; break;
                case 69: this.ParameterNameAndUnit = "Column-integrated in-cloud scavenging rate by large-scale precipitation(kg m-2 s-1)"; break;
                case 70: this.ParameterNameAndUnit = "Column-integrated below-cloud scavenging rate by large-scale precipitation(kg m-2 s-1)"; break;
                case 71: this.ParameterNameAndUnit = "Column-integrated release rate from evaporating large-scale precipitation(kg m-2 s-1)"; break;
                case 72: this.ParameterNameAndUnit = "Column-integrated in-cloud scavenging rate by convective precipitation(kg m-2 s-1)"; break;
                case 73: this.ParameterNameAndUnit = "Column-integrated below-cloud scavenging rate by convective precipitation(kg m-2 s-1)"; break;
                case 74: this.ParameterNameAndUnit = "Column-integrated release rate from evaporating convective precipitation(kg m-2 s-1)"; break;
                case 75: this.ParameterNameAndUnit = "Wildfire flux(kg m-2 s-1)"; break;
                case 76: this.ParameterNameAndUnit = "Emission Rate(kg kg-1 s-1)"; break;
                case 77: this.ParameterNameAndUnit = "Surface Emission flux(kg m-2 s-1)"; break;
                case 78: this.ParameterNameAndUnit = "Column integrated eastward mass flux(kg m-2 s-1)"; break;
                case 79: this.ParameterNameAndUnit = "Column integrated northward mass flux(kg m-2 s-1)"; break;
                case 80: this.ParameterNameAndUnit = "Column integrated divergence of mass flux(kg m-2 s-1)"; break;
                case 81: this.ParameterNameAndUnit = "Column integrated net source(kg m-2 s-1)"; break;
                case 82: this.ParameterNameAndUnit = "Sink mass flux(kg m-2 s-1)"; break;
                case 83: this.ParameterNameAndUnit = "Source mass flux(kg m-2 s-1)"; break;
                case 84: this.ParameterNameAndUnit = "Volume-mean total column mixing ratio(mol mol-1)"; break;
                ...
                case 112: this.ParameterNameAndUnit = "Absorption Aerosol Optical Thickness(Numeric)"; break;
                case 113: this.ParameterNameAndUnit = "Aerosol Backscatter Coefficient(m-1 sr-1)"; break;
                case 255: this.ParameterNameAndUnit = "Missing"; break;
                default : this.ParameterNameAndUnit = nf(this.ParameterNumberByProductDisciplineAndParameterCategory, 0); break;
              }
            }
            ...
            if (this.CategoryOfParametersByProductDiscipline == 0) { // Hydrology Basic
              switch (this.ParameterNumberByProductDisciplineAndParameterCategory) {
                ...
                case 7: this.ParameterNameAndUnit = "Discharge from Rivers or Streams(m3 s-1)"; break;
                case 8: this.ParameterNameAndUnit = "Group Water Upper Storage(kg m-2)"; break;
                case 9: this.ParameterNameAndUnit = "Group Water Lower Storage(kg m-2)"; break;
                case 10: this.ParameterNameAndUnit = "Side Flow into River Channel(m3 s-1 m-1)"; break;
                case 11: this.ParameterNameAndUnit = "River Storage of Water(m3)"; break;
                case 12: this.ParameterNameAndUnit = "Flood Plain Storage of Water(m3)"; break;
                case 13: this.ParameterNameAndUnit = "Depth of Water on Soil Surface(kg m-2)"; break;
                case 14: this.ParameterNameAndUnit = "Upstream Accumulated Precipitation(kg m-2)"; break;
                case 15: this.ParameterNameAndUnit = "Upstream Accumulated Snow Melt(kg m-2)"; break;
                case 16: this.ParameterNameAndUnit = "Percolation Rate(kg m-2 s-1)"; break;
                case 17: this.ParameterNameAndUnit = "River outflow of water(m3 s-1)"; break;
                case 18: this.ParameterNameAndUnit = "Floodplain outflow of water(m3 s-1)"; break;
                case 19: this.ParameterNameAndUnit = "Floodpath outflow of water(m3 s-1)"; break;
                case 20: this.ParameterNameAndUnit = "Water on surface(kg m-2)"; break;
                case 21: this.ParameterNameAndUnit = "Water Surface Elevation(m)"; break;
                case 22: this.ParameterNameAndUnit = "Groundwater Return Flow Rate(m3 s-1)"; break;
                case 23: this.ParameterNameAndUnit = "River and Floodplain Storage(m3)"; break;
                case 24: this.ParameterNameAndUnit = "Depth Averaged River Velocity(m s-1)"; break;
                ...
                case 194: this.ParameterNameAndUnit = "Flood Hazard Outlook"; break;
                case 196: this.ParameterNameAndUnit = "Area Hydrologic Discussion"; break;
                case 255: this.ParameterNameAndUnit = "Missing"; break;
                default : this.ParameterNameAndUnit = nf(this.ParameterNumberByProductDisciplineAndParameterCategory, 0); break;
              }
            }
            ...
            if (this.CategoryOfParametersByProductDiscipline == 0) { // Vegetation/Biomass
              switch (this.ParameterNumberByProductDisciplineAndParameterCategory) {
                ...
                case 33: this.ParameterNameAndUnit = "Water Runoff and Drainage(kg m-2)"; break;
                case 34: this.ParameterNameAndUnit = "Surface Water Runoff(kg m-2)"; break;
                case 35: this.ParameterNameAndUnit = "Tile Class(See Table 4.243)"; break;
                case 36: this.ParameterNameAndUnit = "Tile Fraction(Proportion)"; break;
                case 37: this.ParameterNameAndUnit = "Tile Percentage(%)"; break;
                case 38: this.ParameterNameAndUnit = "Soil Volumetric Ice Content (Water Equivalent)(m3 m-3)"; break;
                case 39: this.ParameterNameAndUnit = "Evapotranspiration Rate(kg m-2 s-1)"; break;
                case 40: this.ParameterNameAndUnit = "Potential Evapotranspiration Rate(kg m-2 s-1)"; break;
                case 41: this.ParameterNameAndUnit = "Snow Melt Rate(kg m-2 s-1)"; break;
                case 42: this.ParameterNameAndUnit = "Water Runoff and Drainage Rate(kg m-2 s-1)"; break;
                case 43: this.ParameterNameAndUnit = "Drainage Direction(See Table 4.250)"; break;
                case 44: this.ParameterNameAndUnit = "Upstream Area(m2)"; break;
                case 45: this.ParameterNameAndUnit = "Wetland Cover(Proportion)"; break;
                case 46: this.ParameterNameAndUnit = "Wetland Type(See Table 4.239)"; break;
                case 47: this.ParameterNameAndUnit = "Irrigation Cover(Proportion)"; break;
                case 48: this.ParameterNameAndUnit = "C4 Crop Cover(Proportion)"; break;
                case 49: this.ParameterNameAndUnit = "C4 Grass Cover(Proportion)"; break;
                case 50: this.ParameterNameAndUnit = "Skin Resovoir Content(kg m-2)"; break;
                case 51: this.ParameterNameAndUnit = "Surface Runoff Rate(kg m-2 s-1)"; break;
                case 52: this.ParameterNameAndUnit = "Subsurface Runoff Rate(kg m-2 s-1)"; break;
                case 53: this.ParameterNameAndUnit = "Low-Vegetation Cover(Proportion)"; break;
                case 54: this.ParameterNameAndUnit = "High-Vegetation Cover(Proportion)"; break;
                case 55: this.ParameterNameAndUnit = "Leaf Area Index (Low-Vegetation)(m2 m-2)"; break;
                case 56: this.ParameterNameAndUnit = "Leaf Area Index (High-Vegetation)(m2 m-2)"; break;
                case 57: this.ParameterNameAndUnit = "Type of Low-Vegetation(See Table 4.234)"; break;
                case 58: this.ParameterNameAndUnit = "Type of High-Vegetation(See Table 4.234)"; break;
                case 59: this.ParameterNameAndUnit = "Net Ecosystem Exchange Flux(kg-2 s-1)"; break;
                case 60: this.ParameterNameAndUnit = "Gross Primary Production Flux(kg-2 s-1)"; break;
                case 61: this.ParameterNameAndUnit = "Ecosystem Respiration Flux(kg-2 s-1)"; break;
                case 62: this.ParameterNameAndUnit = "Emissivity(Proportion)"; break;
                case 63: this.ParameterNameAndUnit = "Canopy air temperature(K)"; break;
                ...
                case 231: this.ParameterNameAndUnit = "Seasonally Minimum Green Vegetation Fraction (over 1-year period)(%)"; break;
                case 232: this.ParameterNameAndUnit = "Seasonally Maximum Green Vegetation Fraction (over 1-year period)(%)"; break;
                case 233: this.ParameterNameAndUnit = "Land Fraction(Fraction)"; break;
                case 234: this.ParameterNameAndUnit = "Lake Fraction(Fraction)"; break;
                case 235: this.ParameterNameAndUnit = "Precipitation Advected Heat Flux(W m-2)"; break;
                case 236: this.ParameterNameAndUnit = "Water Storage in Aquifer(kg m-2)"; break;
                case 237: this.ParameterNameAndUnit = "Evaporation of Intercepted Water(kg m-2)"; break;
                case 238: this.ParameterNameAndUnit = "Plant Transpiration(kg m-2)"; break;
                case 239: this.ParameterNameAndUnit = "Soil Surface Evaporation(kg m-2)"; break;
                case 240: this.ParameterNameAndUnit = "Mixing Length Scale(m)"; break;
                case 255: this.ParameterNameAndUnit = "Missing"; break;
                default : this.ParameterNameAndUnit = nf(this.ParameterNumberByProductDisciplineAndParameterCategory, 0); break;
              }
            }
              ...
              switch (this.ParameterNumberByProductDisciplineAndParameterCategory) {
                ...
                case 4: this.ParameterNameAndUnit = "Fosberg Index(Numeric)"; break;
                case 5: this.ParameterNameAndUnit = "Forest Fire Weather Index (as defined by the Canadian Forest Service)(Numeric)"; break;
                case 6: this.ParameterNameAndUnit = "Fine Fuel Moisture Code (as defined by the Canadian Forest Service)(Numeric)"; break;
                case 7: this.ParameterNameAndUnit = "Duff Moisture Code (as defined by the Canadian Forest Service)(Numeric)"; break;
                case 8: this.ParameterNameAndUnit = "Drought Code (as defined by the Canadian Forest Service)(Numeric)"; break;
                case 9: this.ParameterNameAndUnit = "Initial Fire Spread Index (as defined by the Canadian Forest Service)(Numeric)"; break;
                case 10: this.ParameterNameAndUnit = "Fire Buildup Index (as defined by the Canadian Forest Service)(Numeric)"; break;
                case 11: this.ParameterNameAndUnit = "Fire Daily Severity Rating (as defined by the Canadian Forest Service)(Numeric)"; break;
                case 12: this.ParameterNameAndUnit = "Keetch-Byram Drought Index(Numeric)"; break;
                case 13: this.ParameterNameAndUnit = "Drought Factor (as defined by the Australian Forest Service)(Numeric)"; break;
                case 14: this.ParameterNameAndUnit = "Rate of Spread (as defined by the Australian Forest Service)(m s-1)"; break;
                case 15: this.ParameterNameAndUnit = "Fire Danger index (as defined by the Australian Forest Service)(Numeric)"; break;
                case 16: this.ParameterNameAndUnit = "Spread Component (as defined by the US Forest Service National Fire Danger Rating System)(Numeric)"; break;
                case 17: this.ParameterNameAndUnit = "Burning Index (as defined by the US Forest Service National Fire Danger Rating System)(Numeric)"; break;
                case 18: this.ParameterNameAndUnit = "Ignition Component (as defined by the US Forest Service National Fire Danger Rating System)(%)"; break;
                case 19: this.ParameterNameAndUnit = "Energy Release Component (as defined by the US Forest Service National Fire Danger Rating System)(J m-2)"; break;
                case 20: this.ParameterNameAndUnit = "Burning Area(%)"; break;
                case 21: this.ParameterNameAndUnit = "Burnable Area(%)"; break;
                case 22: this.ParameterNameAndUnit = "Unburnable Area(%)"; break;
                case 23: this.ParameterNameAndUnit = "Fuel Load(kg m-2)"; break;
                case 24: this.ParameterNameAndUnit = "Combustion Completeness(%)"; break;
                case 25: this.ParameterNameAndUnit = "Fuel Moisture Content(kg kg-1)"; break;
                case 26: this.ParameterNameAndUnit = "Wildfire Potential (as defined by the US NOAA Global Systems Laboratory)(Numeric)"; break;
                case 27: this.ParameterNameAndUnit = "Live Leaf Fuel Load(kg m-2)"; break;
                case 28: this.ParameterNameAndUnit = "Live Wood Fuel Load(kg m-2)"; break;
                case 29: this.ParameterNameAndUnit = "Dead Leaf Fuel Load(kg m-2)"; break;
                case 30: this.ParameterNameAndUnit = "Dead Wood Fuel Load(kg m-2)"; break;
                case 31: this.ParameterNameAndUnit = "Live Fuel Moisture Content(kg kg-1)"; break;
                case 32: this.ParameterNameAndUnit = "Fine Dead Leaf Moisture Content(kg kg-1)"; break;
                case 33: this.ParameterNameAndUnit = "Dense Dead Leaf Moisture Content(kg kg-1)"; break;
                case 34: this.ParameterNameAndUnit = "Fine Dead Wood Moisture Content(kg kg-1)"; break;
                case 35: this.ParameterNameAndUnit = "Dense Dead Wood Moisture Content(kg kg-1)"; break;
                case 36: this.ParameterNameAndUnit = "Fire Radiative Power(W)"; break;
                case 37: this.ParameterNameAndUnit = "Live Fuel Moisture Content in Low Vegetation(kg kg-1)"; break;
                case 38: this.ParameterNameAndUnit = "Live Fuel Moisture Content in High Vegetation(kg kg-1)"; break;
                case 39: this.ParameterNameAndUnit = "Mean Height of Maximum Injection(m)"; break;
                case 40: this.ParameterNameAndUnit = "Injection Height(m)"; break;
                case 41: this.ParameterNameAndUnit = "Plume Bottom Height(m)"; break;
                case 42: this.ParameterNameAndUnit = "Plume Top Height(m)"; break;
                case 43: this.ParameterNameAndUnit = "Probability of Fire Detection(%)"; break;
                case 44: this.ParameterNameAndUnit = "Probability of Ignition from Lightning(%)"; break;
                case 255: this.ParameterNameAndUnit = "Missing"; break;
                default : this.ParameterNameAndUnit = nf(this.ParameterNumberByProductDisciplineAndParameterCategory, 0); break;
              }
            }
            ...
            if (this.CategoryOfParametersByProductDiscipline == 0) { // Waves
              switch (this.ParameterNumberByProductDisciplineAndParameterCategory) {
                ...
                case 44: this.ParameterNameAndUnit = "Benjamin-Feir Index(-)"; break;
                case 45: this.ParameterNameAndUnit = "Spectral Peakedness Factor(s-1)"; break;
                case 46: this.ParameterNameAndUnit = "Peak wave direction(°)"; break;
                case 47: this.ParameterNameAndUnit = "Significant wave height of first swell partition(m)"; break;
                case 48: this.ParameterNameAndUnit = "Significant wave height of second swell partition(m)"; break;
                case 49: this.ParameterNameAndUnit = "Significant wave height of third swell partition(m)"; break;
                case 50: this.ParameterNameAndUnit = "Mean wave period of first swell partition(s)"; break;
                case 51: this.ParameterNameAndUnit = "Mean wave period of second swell partition(s)"; break;
                case 52: this.ParameterNameAndUnit = "Mean wave period of third swell partition(s)"; break;
                case 53: this.ParameterNameAndUnit = "Mean wave direction of first swell partition(°)"; break;
                case 54: this.ParameterNameAndUnit = "Mean wave direction of second swell partition(°)"; break;
                case 55: this.ParameterNameAndUnit = "Mean wave direction of third swell partition(°)"; break;
                case 56: this.ParameterNameAndUnit = "Wave directional width of first swell partition(-)"; break;
                case 57: this.ParameterNameAndUnit = "Wave directional width of second swell partition(-)"; break;
                case 58: this.ParameterNameAndUnit = "Wave directional width of third swell partition(-)"; break;
                case 59: this.ParameterNameAndUnit = "Wave frequency width of first swell partition(-)"; break;
                case 60: this.ParameterNameAndUnit = "Wave frequency width of second swell partition(-)"; break;
                case 61: this.ParameterNameAndUnit = "Wave frequency width of third swell partition(-)"; break;
                case 62: this.ParameterNameAndUnit = "Wave frequency width(-)"; break;
                case 63: this.ParameterNameAndUnit = "Frequency width of wind waves(-)"; break;
                case 64: this.ParameterNameAndUnit = "Frequency width of total swell(-)"; break;
                case 65: this.ParameterNameAndUnit = "Peak Wave Period of First Swell Partition(s)"; break;
                case 66: this.ParameterNameAndUnit = "Peak Wave Period of Second Swell Partition(s)"; break;
                case 67: this.ParameterNameAndUnit = "Peak Wave Period of Third Swell Partition(s)"; break;
                case 68: this.ParameterNameAndUnit = "Peak Wave Direction of First Swell Partition(degree true)"; break;
                case 69: this.ParameterNameAndUnit = "Peak Wave Direction of Second Swell Partition(degree true)"; break;
                case 70: this.ParameterNameAndUnit = "Peak Wave Direction of Third Swell Partition(degree true"; break;
                case 71: this.ParameterNameAndUnit = "Peak Direction of Wind Waves(degree true)"; break;
                case 72: this.ParameterNameAndUnit = "Peak Direction of Total Swell(degree true)"; break;
                case 73: this.ParameterNameAndUnit = "Whitecap Fraction(fraction)"; break;
                case 74: this.ParameterNameAndUnit = "Mean Direction of Total Swell(degree)"; break;
                case 75: this.ParameterNameAndUnit = "Mean Direction of Wind Waves(degree)"; break;
                case 76: this.ParameterNameAndUnit = "Charnock(Numeric)"; break;
                case 77: this.ParameterNameAndUnit = "Wave Spectral Skewness(Numeric)"; break;
                case 78: this.ParameterNameAndUnit = "Wave Energy Flux Magnitude(W m-1)"; break;
                case 79: this.ParameterNameAndUnit = "Wave Energy Flux Mean Direction(degree true)"; break;
                case 80: this.ParameterNameAndUnit = "Ratio of Wave Angular and Frequency Width(Numeric)"; break;
                case 81: this.ParameterNameAndUnit = "Free Convective Velocity over the Oceans(m s-1)"; break;
                case 82: this.ParameterNameAndUnit = "Air Density over the Oceans(kg m-3)"; break;
                case 83: this.ParameterNameAndUnit = "Normalized Energy Flux into Waves(Numeric)"; break;
                case 84: this.ParameterNameAndUnit = "Normalized Stress into Ocean(Numeric)"; break;
                case 85: this.ParameterNameAndUnit = "Normalized Energy Flux into Ocean(Numeric)"; break;
                case 86: this.ParameterNameAndUnit = "Surface Elevation Variance due to Waves(m2 s rad-1)"; break;
                case 87: this.ParameterNameAndUnit = "Wave Induced Mean Sea Level Correction(m)"; break;
                case 88: this.ParameterNameAndUnit = "Spectral Width Index(Numeric)"; break;
                case 89: this.ParameterNameAndUnit = "Number of Events in Freak Wave Statistics(Numeric)"; break;
              ...
              switch (this.ParameterNumberByProductDisciplineAndParameterCategory) {
                ...
                case 10: this.ParameterNameAndUnit = "Zonal Vector Component of Vertically Integrated Ice Internal Pressure(Pa m)"; break;
                case 11: this.ParameterNameAndUnit = "Meridional Vector Component of Vertically Integrated Ice Internal Pressure(Pa m)"; break;
                case 12: this.ParameterNameAndUnit = "Compressive Ice Strength(N m-1)"; break;
                case 13: this.ParameterNameAndUnit = "Snow Temperature (over sea ice)(K)"; break;
                case 14: this.ParameterNameAndUnit = "Albedo(Numeric)"; break;
                case 15: this.ParameterNameAndUnit = "Sea Ice Volume per Unit Area(m3m-2)"; break;
                case 16: this.ParameterNameAndUnit = "Snow Volume Over Sea Ice per Unit Area(m3m-2)"; break;
                case 17: this.ParameterNameAndUnit = "Sea Ice Heat Content(J m-2)"; break;
                case 18: this.ParameterNameAndUnit = "Snow over Sea Ice Heat Content(J m-2)"; break;
                case 19: this.ParameterNameAndUnit = "Ice Freeboard Thickness(m)"; break;
                case 20: this.ParameterNameAndUnit = "Ice Melt Pond Fraction(fraction)"; break;
                case 21: this.ParameterNameAndUnit = "Ice Melt Pond Depth(m)"; break;
                case 22: this.ParameterNameAndUnit = "Ice Melt Pond Volume per Unit Area(m3m-2)"; break;
                case 23: this.ParameterNameAndUnit = "Sea Ice Fraction Tendency due to Parameterization(s-1)"; break;
                case 24: this.ParameterNameAndUnit = "X-Component of Ice Drift(m s-1)"; break;
                case 25: this.ParameterNameAndUnit = "Y-Component of Ice Drift(m s-1)"; break;
                case 26: this.ParameterNameAndUnit = "Sea Ice Salinity(g kg-1)"; break;
                case 27: this.ParameterNameAndUnit = "Freezing/Melting Potential(W m-2)"; break;
                case 28: this.ParameterNameAndUnit = "Melt Onset Date(Numeric)"; break;
                case 29: this.ParameterNameAndUnit = "Freeze Onset Date(Numeric)"; break;
                case 30: this.ParameterNameAndUnit = "Sea Ice Breakup Memory(Numeric)"; break;
                case 31: this.ParameterNameAndUnit = "Downward Shortwave Radiation Flux(W m-2)"; break;
                case 255: this.ParameterNameAndUnit = "Missing"; break;
                default : this.ParameterNameAndUnit = nf(this.ParameterNumberByProductDisciplineAndParameterCategory, 0); break;
              }
            }
              ...
              switch (this.ParameterNumberByProductDisciplineAndParameterCategory) {
                ...
                case 16: this.ParameterNameAndUnit = "Water Density (rho)(kg m-3)"; break;
                case 17: this.ParameterNameAndUnit = "Water Density Anomaly (sigma)(kg m-3)"; break;
                case 18: this.ParameterNameAndUnit = "Water Potential Temperature (theta)(K)"; break;
                case 19: this.ParameterNameAndUnit = "Water Potential Density (rho theta)(kg m-3)"; break;
                case 20: this.ParameterNameAndUnit = "Water Potential Density Anomaly (sigma theta)(kg m-3)"; break;
                case 21: this.ParameterNameAndUnit = "Practical Salinity(psu (numeric))"; break;
                case 22: this.ParameterNameAndUnit = "Water Column-integrated Heat Content(J m-2)"; break;
                case 23: this.ParameterNameAndUnit = "Eastward Water Velocity(m s-1)"; break;
                case 24: this.ParameterNameAndUnit = "Northward Water Velocity(m s-1)"; break;
                case 25: this.ParameterNameAndUnit = "X-Component Water Velocity(m s-1)"; break;
                case 26: this.ParameterNameAndUnit = "Y-Component Water Velocity(m s-1)"; break;
                case 27: this.ParameterNameAndUnit = "Upward Water Velocity(m s-1)"; break;
                case 28: this.ParameterNameAndUnit = "Vertical Eddy Diffusivity(m2 s-1)"; break;
                case 29: this.ParameterNameAndUnit = "Bottom Pressure Equivalent Height(m)"; break;
                case 30: this.ParameterNameAndUnit = "Fresh Water Flux into Sea Water from Rivers(kg m-2s-1)"; break;
                case 31: this.ParameterNameAndUnit = "Fresh Water Flux Correction(kg m-2s-1)"; break;
                case 32: this.ParameterNameAndUnit = "Virtual Salt Flux into Sea Water(g kg-1 m-2s-1)"; break;
                case 33: this.ParameterNameAndUnit = "Virtual Salt Flux Correction(g kg-1 m-2s-1)"; break;
                case 34: this.ParameterNameAndUnit = "Sea Water Temperature Tendency due to Newtonian Relaxation(K s-1)"; break;
                case 35: this.ParameterNameAndUnit = "Sea Water Salinity Tendency due to Newtonian Relaxation(g kg-1s-1)"; break;
                case 36: this.ParameterNameAndUnit = "Sea Water Temperature Tendency due to Parameterization(K s-1)"; break;
                case 37: this.ParameterNameAndUnit = "Sea Water Salinity Tendency due to Parameterization(g kg-1s-1)"; break;
                case 38: this.ParameterNameAndUnit = "Eastward Sea Water Velocity Tendency Due To Parameterization(m s-2)"; break;
                case 39: this.ParameterNameAndUnit = "Northward Sea Water Velocity Tendency Due To Parameterization(m s-2)"; break;
                case 40: this.ParameterNameAndUnit = "Sea Water Temperature Tendency Due to Direct Bias Correction(K s-1)"; break;
                case 41: this.ParameterNameAndUnit = "Sea Water Salinity Tendency due to Direct Bias Correction(g kg-1s-1)"; break;
                case 42: this.ParameterNameAndUnit = "Sea water meridional volume transport(m3 m-2 s-1)"; break;
                case 43: this.ParameterNameAndUnit = "Sea water zonal volume transport(m3 m-2 s-1)"; break;
                case 44: this.ParameterNameAndUnit = "Sea water column integrated meridional volume transport(m3 m-2 s-1)"; break;
                case 45: this.ParameterNameAndUnit = "Sea water column integrated zonal volume transport(m3 m-2 s-1)"; break;
                case 46: this.ParameterNameAndUnit = "Sea water meridional mass transport(kg m-2 s-1)"; break;
                case 47: this.ParameterNameAndUnit = "Sea water zonal mass transport(kg m-2 s-1)"; break;
                case 48: this.ParameterNameAndUnit = "Sea water column integrated meridional mass transport(kg m-2 s-1)"; break;
                case 49: this.ParameterNameAndUnit = "Sea water column integrated zonal mass transport(kg m-2 s-1)"; break;
                case 50: this.ParameterNameAndUnit = "Sea water column integrated practical salinity(g kg-1 m)"; break;
                case 51: this.ParameterNameAndUnit = "Sea water column integrated salinity(kg kg-1 m)"; break;
                case 52: this.ParameterNameAndUnit = "Mixed Layer Depth(m)"; break;
                case 53: this.ParameterNameAndUnit = "Normal Component of Water Velocity(m s-1)"; break;
                case 54: this.ParameterNameAndUnit = "Tangential Component of Water Velocity(m s-1)"; break;
                case 55: this.ParameterNameAndUnit = "Sea Water Upward Volume Transport(m3 m-2 s-1)"; break;
                case 56: this.ParameterNameAndUnit = "Sea Water Upward Mass Transport(kg m-2 s-1)"; break;
                case 57: this.ParameterNameAndUnit = "Sea Water Age Since Surface Contact(s)"; break;
                case 58: this.ParameterNameAndUnit = "Sea Water Downward Shortwave Radiation Flux(W m-2)"; break;
        ...
        if (
          ...
          if (SectionNumbers.length > 100) { // ???????? to handle the case of no bitmap
            ...
            if (this.DataRepresentationTemplateNumber == 40) {
